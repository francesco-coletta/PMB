...
// +-------------------------------------------------+
// $Id: epub.class.php,v 1.1 2012-10-22 12:18:53 jpermanne Exp $
...
class epub extends affichage{
    ...
    function fetchDisplay(){
    	...
    	$ebook = new epubData($visionneuse_path."/temp/".$this->doc->id);
     	//le titre
    	...
    	<script type='text/javascript'>
			...
			function goPage(page) {
				//On charge la page
				iframe.src='visionneuse.php/".$this->doc->id."/'+page;
			}
