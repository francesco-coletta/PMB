...
// +-------------------------------------------------+
// $Id: audio.class.php,v 1.2 2013-03-25 10:32:40 mbertin Exp $
...
class audio extends affichage{
    ...
    function fetchDisplay(){
    	...
    	<object type='application/x-shockwave-flash' data='$visionneuse_path/classes/mimetypes/audio/player/player_mp3.swf' width='".$this->parameters["size_x"]."' height='".$this->parameters["size_y"]."'>
			...
			<param name='FlashVars' value='mp3=./doc_num_data.php?explnum_id=".$this->doc->id."&amp;showstop=".$this->parameters["showstop"]."&amp;showinfo=".$this->parameters["showinfo"]."&amp;showvolume=".$this->parameters["showvolume"]."' />
...
//			<param name='wmode' value='transparent' />
//			<param name='movie' value='$visionneuse_path/classes/mimetypes/audio/player/player_mp3.swf' />
//			<param name='FlashVars' value='mp3=$base_path/visionneuse.php?lvl=afficheur&explnum=".$this->doc->id."&amp;showstop=".$this->parameters["showstop"]."&amp;showinfo=".$this->parameters["showinfo"]."&amp;showvolume=".$this->parameters["showvolume"]."' />
//			<embed pluginspage='http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash'>
//		</object>";
