...
// +-------------------------------------------------+
// $Id: flexpdf.class.php,v 1.8 2013-04-11 08:30:32 mbertin Exp $
...
class flexpdf extends affichage{
    	...
    	<script type='text/javascript'> 
    			window.onload = function(){
					...
					$('#flexpaperFrameViewer').FlexPaperViewer({ config : {
							 SWFFile : ".pmb_escape()."('visionneuse.php?lvl=afficheur&explnum=".$this->doc->id."'),
    ...
    function render(){
    	...
    	if (!$this->driver->isInCache($this->doc->id)) {
    		$converter = converter_factory::make(	$this->driver->currentDoc['id'],
