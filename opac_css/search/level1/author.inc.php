...
// +-------------------------------------------------+
// $Id: author.inc.php,v 1.43 2012-08-23 14:58:11 mbertin Exp $
...
if($opac_allow_affiliate_search){
	...
	print "
		...
		<script type='text/javascript'>
			...
			author_search.request('./ajax.php?module=ajax&categ=search',true,'&search_type=authorities&type=author&user_query=".rawurlencode(stripslashes($user_query))."',true,authorResults);
