...
// +-------------------------------------------------+
// $Id: extended.inc.php,v 1.25 2012-07-13 10:30:13 dbellamy Exp $
...
if (!$flag) {
	...
	if($opac_allow_affiliate_search){
		...
		$search_result_affiliate_extented =  str_replace("!!user_query!!",rawurlencode($es->serialize_search()),$search_result_affiliate_extented);
