...
// +-------------------------------------------------+
// $Id: serialcirc_empr.class.php,v 1.16 2012-03-12 15:18:37 arenou Exp $
...
class serialcirc_empr_circ{
	...
	public function get_tab_row($css_class){
		...
		if($this->get_issue_id()!=0){
			$issue = "<a href='".$opac_url_base."index.php?lvl=notice_display&id=".$this->get_issue_id()."'>".htmlentities($this->get_issue_title(),ENT_QUOTES,$charset)."</a>";
		}else{
