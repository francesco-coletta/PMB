...
// +-------------------------------------------------+
// $Id: suggest.class.php,v 1.4.2.1 2013-06-11 06:59:44 jpermanne Exp $
...
// ---------------------------------------------------------------------------------------------------
	function findWords() {
		$tmpMots = str_replace("%","",$this->inputString);
		$tmpMots = convert_diacrit($tmpMots);
		//on enlève les mots vides
		$tmpMots = strip_empty_words($tmpMots);
		$this->arrayWords = str_word_count($tmpMots,1);
