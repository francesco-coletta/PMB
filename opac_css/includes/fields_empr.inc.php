...
// +-------------------------------------------------+
// $Id: fields_empr.inc.php,v 1.34.2.2 2013-06-24 15:11:23 mbertin Exp $
	...
	foreach($field[VALUES] as $id){
		switch($field["OPTIONS"][0]["DATA_TYPE"]["0"]["value"]) {
			case 1:// auteur
				...
				break;
			case 2:// categories
				$isbd_s[]=categories::listAncestorNames($id,$lang);
				break;
			case 3:// Editeur				
				$aut=new publisher($id);
				$isbd_s[]=$aut->isbd_entry;
