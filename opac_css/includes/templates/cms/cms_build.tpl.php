...
// +-------------------------------------------------+
// $Id: cms_build.tpl.php,v 1.2 2012-04-17 13:24:01 ngantier Exp $
...
<script type='text/javascript'>
    ...
    function cms_build_page_edit_add(id){
    	...
    	if(!dijit.byId('cms_build_dialog')){
	        ...
	        try {var myDijit = new dojox.widget.DialogSimple({title: 'Referent', id:'cms_build_dialog'});    }catch(e){console.log(e);};
