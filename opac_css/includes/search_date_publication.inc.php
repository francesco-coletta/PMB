...
// +-------------------------------------------------+
// $Id: search_date_publication.inc.php,v 1.2 2013-01-11 15:08:57 mbertin Exp $

function search_other_function_filters() {
	global $sig_choix,$sig_date_debut,$sig_date_fin,$charset;

	$r="<br/><br/><div style='float:left;margin-right:10px;'><label class='etiquette' for='sig_choix'>Recherche par date: </label><select name='sig_choix' id='sig_choix'>\n" .
			"<option value='vide' !!vide!! >&nbsp;Choisir une option&nbsp;&nbsp;</option>\n" .
			"<option value='exacte' !!exacte!! >&nbsp;Date exacte</option>\n" .
			"<option value='entre' !!entre!! >&nbsp;Période</option>\n" .
			"<option value='debut' !!debut!! >&nbsp;Après le</option>\n" .
			"<option value='fin' !!fin!! >&nbsp;Avant le</option>\n" .
...
function search_other_function_human_query($n) {
	...
	if($sig_choix == "exacte" && $sig_date_debut ){
		$r1="Date de publication égale au ".$sig_date_debut;
	}elseif($sig_date_debut && $sig_date_fin){
		$r1="Date de publication entre le ".$sig_date_debut." et le ".$sig_date_fin;
	}elseif($sig_date_debut){
		$r1="Date de publication supérieure au ".$sig_date_debut;
	}elseif($sig_date_fin){
		$r1="Date de publication inférieur au ".$sig_date_fin;
	}
