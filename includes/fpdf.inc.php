...
// +-------------------------------------------------+
// $Id: fpdf.inc.php,v 1.74 2013-05-17 09:59:29 dgoron Exp $
...
function expl_retard($cb_doc, $x, $y, $largeur, $retrait, $link) {
	...
	$ourPDF->setFont($pmb_pdf_font, 'I', 8);
	$ourPDF->multiCell(($largeur - $retrait - $x), 8, strip_tags($expl->location_libelle.": ".$expl->section_libelle.", ".$expl->expl_cote." (".$expl->expl_cb.")"), 0, 'L', 0);
