...
// +-------------------------------------------------+
// $Id: cms_build.tpl.php,v 1.53 2013-04-19 13:21:43 ngantier Exp $
...
<script type='text/javascript'>
    ...
    function cms_build_page_edit_add(id){
     	if(!dijit.byId('cms_build_dialog')){
	        ...
	        try {var myDijit = new dojox.widget.DialogSimple({title: 'Referent',executeScripts:true, id:'cms_build_dialog'});    }catch(e){console.log(e);};
		}  				
        //get the dialog
