...
// +-------------------------------------------------+
// $Id: empr.tpl.php,v 1.151.2.1 2013-09-17 14:08:29 dbellamy Exp $
	...
	$empr_pret_allowed="
		<div id='loan_zone' >
			<div class='left'>
				...
				$rfid_input_cb
				$indicateur_rfid
				".(($pmb_short_loan_management==1)?"<br /><span id='short_loan_msg' class='short_loan_msg'>".(($short_loan==1)?$msg['short_loan_enabled']:$msg['short_loan_disabled']).'</span>':'')."
			</div>
			<div class='right'>
...
if ($pmb_short_loan_management==1) {
	$short_loan_bt = "
			<input type='button' class='bouton' name='short_loan_bt' id='short_loan_bt' value='".(($short_loan==1)?$msg['short_loan_disable']:$msg['short_loan_enable'])."' onclick='flip_short_loan();' />
			<input type='hidden' id='short_loan' name='short_loan' value='".(($short_loan==1)?1:0)."' />
			<script type='text/javascript'>
