...
// +-------------------------------------------------+
// $Id: pointage_exemplarise.php,v 1.41.2.2 2013-08-08 09:43:49 dgoron Exp $
...
$templates = <<<ENDOFFILE
			<script type='text/javascript'>
				...
				function enregistre(obj,bul_id) {
					...
					desactive(obj)
					parent.document.getElementById(obj_bul).innerHTML="<a href='./catalog.php?categ=serials&sub=bulletinage&action=view&bul_id="+bul_id+"'>"+"!!Voir_le_bulletin!!"+"</a>!!serialcir_print!!";
