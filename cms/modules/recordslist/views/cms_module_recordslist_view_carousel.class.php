...
// +-------------------------------------------------+
// $Id: cms_module_recordslist_view_carousel.class.php,v 1.5.2.1 2013-09-04 09:35:35 apetithomme Exp $
...
class cms_module_recordslist_view_carousel extends cms_module_carousel_view_carousel{
	...
	public function render($records){
		...
		$query = "select notice_id,tit1,thumbnail_url,code from notices where notice_id in(".implode(",",$records['records']).")";
