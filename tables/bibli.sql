...
-- +-------------------------------------------------+
-- $Id: bibli.sql,v 1.70 2012-12-05 09:41:52 mbertin Exp $
...
CREATE TABLE bulletins (
  ...
  mention_date varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE empr (
  ...
  empr_msg tinytext COLLATE utf8_unicode_ci,
...
CREATE TABLE groupe (
  ...
  libelle_groupe varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE notices_mots_global_index (
  ...
  pond int(4) NOT NULL DEFAULT '100',
  position int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (id_notice,code_champ,code_ss_champ,num_word,position),
...
-- Dump completed on 2012-12-04 10:02:05
