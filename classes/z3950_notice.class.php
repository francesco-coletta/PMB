...
// +-------------------------------------------------+
// $Id: z3950_notice.class.php,v 1.150.2.1 2013-06-26 08:41:38 dgoron Exp $
...
class z3950_notice {
	...
	function get_form ($action, $id_notice=0,$retour='link',$article=false) {
		...
		if ($existing_collection_id) {
			...
			$this->substitute ("f_coll_existing_id", $existing_collection_id, $ptab[2]);
		}
		else {
		...
		if ($existing_subcollection_id) {
			...
			$this->substitute ("f_subcoll_existing_id", $existing_subcollection_id, $ptab[2]);
		}
		else {
