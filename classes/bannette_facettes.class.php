...
// +-------------------------------------------------+
// $Id: bannette_facettes.class.php,v 1.5.2.5 2013-07-03 09:06:33 ngantier Exp $
...
class bannette_facettes{
	...
	function build_document($notice_ids,$notice_tpl=""){
		...
		return $this->filter_facettes_print($res_notice_ids);		
	}
	...
	function filter_facettes_print($res_notice_ids, $rang=1,$notfound=array()){
		...
		foreach($res_notice_ids["folder"] as $folder => $contens){			
				...
				$tpl.="<h$rang class='dsi_rang_$rang'>".$folder."</h$rang>
