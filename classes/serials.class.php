...
// +-------------------------------------------------+
// $Id: serials.class.php,v 1.145 2013-04-11 08:11:34 mbertin Exp $
...
class serial {
	...
	function update($value) {
		...
		notice::majNotices($this->serial_id);	
		return $this->serial_id;
	}
		...
		if (!$dont_update_bul) {
			...
			if($this->bull_num_notice) {
				...
				if ($empty) {
					...
					// Mise à jour des index de la notice
					notice::majNotices($this->bull_num_notice);
	...
	function analysis_update($values) {
	    ...
	    if(is_array($values)) {
			...
			if(!$this->analysis_id) {
				...
				if($this->analysis_id) {
					// Mise à jour des index de la notice
					notice::majNotices($this->analysis_id);
