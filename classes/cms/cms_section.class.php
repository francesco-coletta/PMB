...
// +-------------------------------------------------+
// $Id: cms_section.class.php,v 1.14.2.2 2013-09-06 08:00:10 apetithomme Exp $
...
class cms_section extends cms_editorial {
	...
	public function save(){
		...
		$type_fields = new cms_editorial_parametres_perso($this->num_type);	
		$type_fields->rec_fields_perso($this->id,$this->type);
		$this->maj_indexation();
	}
	...
	public static function get_format_data_structure($get_children= true,$get_articles = true){
		global $msg;
		$format = cms_editorial::get_format_data_structure("section");
		if($get_children){
			$format[] = array(
				'var' => 'children',
