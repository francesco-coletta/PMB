...
// +-------------------------------------------------+
// $Id: author.class.php,v 1.72 2013-04-11 08:06:22 mbertin Exp $
		...
		if($zone == "2"){
			switch($type){
				...
				case 71 :
					...
					$data['date'] = $fields[$field][0]['f'][0];
					$data['subdivision'] = $fields[$field][0]['b'][0];
			...
			switch($type){
				...
				case 71 :
					...
					$data['name'] = $fields['a'][0].((count($fields[$field]['c']) != 0)?" (".implode(", ",$fields[$field]['c']).")":"");
					$data['rejete'] = $fields['g'][0];
					$data['date'] = $fields['f'][0];
					$data['subdivision'] = $fields['b'][0];
