...
// +-------------------------------------------------+
// $Id: category_auto.class.php,v 1.2 2012-01-13 13:54:42 mbertin Exp $
...
class category_auto {
    ...
    function get_info_categ($record){
    ...
    */
    function save_info_categ(&$tabl_categ_lib=""){
    ...
    function browse_subfields($tab_ss_champ,$name_field,&$tabl_categ_has_recovered){
	...
	function browse_category($subfield,$tabl_categ_recovered,$name_field,$counter_field,$id_thes,$root_node_number,&$tabl_categ_lib,$create_node){
	...
	function build_categ($tab_categ,$id_thes,$id_parent,$do_lien=true,$do_create=true){
