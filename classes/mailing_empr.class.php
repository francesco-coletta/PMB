...
// +-------------------------------------------------+
// $Id: mailing_empr.class.php,v 1.1 2012-07-31 10:12:16 dgoron Exp $
	...
	function send($objet_mail, $message, $paquet_envoi=0) {
		...
		if ($this->id_caddie_empr) {
			...
			while ($ienvoi<$n_envoi) {
				...
				$envoi_OK = mailpmb($nomdest, $emaildest, $objet_mail, $message_to_send, $PMBuserprenom." ".$PMBusernom, $PMBuseremail, $headers, "", $PMBuseremailbcc) ;
				if ($envoi_OK) {
