...
// +-------------------------------------------------+
// $Id: user_modif.inc.php,v 1.46 2013-02-26 09:29:36 abacarisse Exp $
...
$requete .="user_email, user_alert_resamail, user_alert_demandesmail, explr_invisible, explr_visible_mod, explr_visible_unmod, grp_num FROM users WHERE userid='$id' LIMIT 1 ";
	...
	switch ($field_deb) {
		...
		case "value_" :
			if ($field == 'value_deflt_fonction'){
				...
				$value_user.="<select onchange='' name='form_value_deflt_relation' size='1'>
