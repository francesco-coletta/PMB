...
// +-------------------------------------------------+
// $Id: user_update.inc.php,v 1.31 2013-03-18 17:10:03 dgoron Exp $
...
if ($nbr > 0) {
	...
	if(!$id) {
		if(!empty($form_login) && $form_pwd==$form_pwd2) {
			...
			$requete.= "nb_per_page_gestion, user_email, user_alert_resamail, user_alert_demandesmail, explr_invisible, explr_visible_mod, explr_visible_unmod";
			if (isset($sel_group)) {
				$requete.= ", grp_num";
			}
			$requete.= ") VALUES";
