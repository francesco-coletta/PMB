...
// +-------------------------------------------------+
// $Id: users_func.inc.php,v 1.33 2013-03-18 17:10:03 dgoron Exp $
...
function user_form($login="", $nom="", $prenom="", $flag=3, $id=0, $lang="", $nb_per_page_search=10, $nb_per_page_select=10, $nb_per_page_gestion=10, $form_param_default="", $form_user_email="", $form_user_alert_resamail="0", $form_user_alert_demandesmail="0", $usr_grp=FALSE ) {
